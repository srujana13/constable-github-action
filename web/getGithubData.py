...
class Github:
    ...
    def get_repo_files(self, repo_name):
        ...
        result = self.client.execute(
            gql(query), variable_values={"name": repo_name})
        file_names = [file['name'] for file in result['viewer']
    ...
    def get_closed_issues(self, repo_name, owner, start_date):
        ...
        result = self.client.execute(gql(query), variable_values={
                                     "repo": repo_name, "owner": owner, "start_date": start_date})
